...
jobRunner2.sh -n "tv-rssd" -t 23 $flags $HOME/scripts/tv-rss.sh -D
jobRunner2.sh -n "tv-rss" -t 13 $flags $HOME/scripts/tv-rss.sh
...
jobRunner2.sh -n "flickr-kelli" -t 1445  $flags $HOME/scripts/photo-fetch.sh -s flickr -d "$HOME/Pictures/ServerFiles/Originals/%Y/%Y-%m-01-KelliFlickr" -u "41352893@N00" -L KelliFlickr
